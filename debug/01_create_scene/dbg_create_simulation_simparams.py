"""Simulation Setup
Ref doc: https://docs.robotsfan.com/isaacgym/programming/simsetup.html
...
object_asset_file = "models/object.obj"
...
for i in range(num_envs):
    ...
    object_pose.p = gymapi.Vec3(0.5, 0, 0.5)  # Position (x, y, z)
